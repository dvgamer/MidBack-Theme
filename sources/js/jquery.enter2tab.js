...
(function () {
    ...
    var INPUT_SELECTOR = "input,select,textarea,button", IGNORE_CSS = "enter-ignore";
    jQuery.fn.getFocusCandidates = function (tabRange) {
      ...
      .filter(
                ...
                //for enter key, enter-ignore fields are excluded
    ...
    jQuery.fn.enableTab = function (options, callback) {
        ...
        return this.each(function () {
            ...
            .on("keydown", "[tabindex]:not(textarea)", function (e) {
                ...
                var $fld = $(this);
                var isIgnore = $fld.is(".enter-ignore"), isKeyOff = $fld.is(".tab-keyoff");
