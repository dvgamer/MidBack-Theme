...
function Flatpickr(element, config) {
	...
	function setupMobile() {
		...
		self.mobileInput = createElement("input", "form-control flatpickr-input flatpickr-mobile");
...
Flatpickr.l10ns = {
	...
	th: {
		...
		months: {
			shorthand: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
			longhand: ["มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน", "พฤษภาคม", "มิถุนายน", "กรกฏาคม", "สิงหาคม", "กันยายน", "ตุลาคม", "พฤษจิกายน", "ธันวาคม"]
		},
		daysInMonth: [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
		firstDayOfWeek: 0,
		ordinal: function ordinal(nth) {
...
Flatpickr.localize = function (l10n) {
	return _extends(Flatpickr.l10ns.default, Flatpickr.l10ns[l10n] || 'en');
};
